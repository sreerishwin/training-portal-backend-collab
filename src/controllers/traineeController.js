...
const latest_trainee_count = async (req, res) => {
    try {
        ...
        const trainee = traineeService.getTraineeByDate()
...
const get_trainer=  async (req, res) => {
    try {
        ...
        const tr_assessments = await traineeassessmentService.get_tAssessmentByTraineeId(traineeId)
        console.log("TR assessments", tr_assessments)
        const result = await  Promise.all(tr_assessments.map(async (tr_assessment) => {
            const assessment = await  traineeService.getTraineeById(tr_assessment.assessment_id)
...
async function getTrainerById(id) {
    console.log("ID", id)
    const trainer = await traineeService.getTraineeById(id);
