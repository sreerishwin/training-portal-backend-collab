...
const create_assessment = async (req, res) => {
  try {
    const assessment = await assessmentService.createAssessments({
      ...req.body,
      assessment_name: req.body.title,
    });
    const traineeAssessment = await assessmentService.createTA({
      ...req.body,
      assessment_id: assessment.id,
      status: req.body.traineeStatus,
    });
...
const completed_assessment = async (req, res) => {
  try {
    ...
    const taFetchedAssessments = await Promise.all(
    ...
    return successResponse(res, {
      completed: taFetchedAssessments,
      percentage: perc,
    });
