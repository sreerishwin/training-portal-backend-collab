...
const trainer_assessment_count = async(req,res)=> {
    try{
        ...
        const assessmentCount = await assessmentService.getAssessmentByTrainerId(trainerID)
...
const trainerPerformance = async (req, res) => {
    try {
        const trainerId = req.params.trainerId;
        const fetchedAssessments = await assessmentService.getAssessmentByTrainerId(trainerId)
...
const updateAssessment = async(req,res)=>{
    try{
        const assessment = await assessmentService.updateAssessment({ ...req.body, created_by: req.body.creator_id });
